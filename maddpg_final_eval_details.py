...
from maddpg_model_test_final_eval import ActorNetwork,CriticNetwork
from maddpg_final_eval_process import eval
import argparse

def main(args):

    with tf.Session() as sess:
        env = gym.make('Multiagent-final-eval-v0')
        ...
        for i in range(n):
            ...
            try:
                file1 = './results/savedmodels/actor'+str(i)+'/mainmodel'+str(1200)+ 'full'+'.h5'
                file2 = './results/savedmodels/actor'+str(i)+'/targetmodel'+str(1200)+ 'full'+'.h5'
                file3 = './results/savedmodels/critic'+str(i)+'/mainmodel'+str(1200)+ 'full'+'.h5'
                file4 = './results/savedmodels/critic'+str(i)+'/targetmodel'+str(1200)+ 'full'+'.h5'
        ...
        eval(sess,env,args,actors,critics, exploration_noise) #
        #if args['use_gym_monitor']:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max-episodes', help='max num of episodes to do while training', default=25)
    ...
    parser.add_argument('--summary-dir', help='directory for storing tensorboard info', default='./results/tf_ddpg_3/eval_final')
